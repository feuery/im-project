...
get the app created:
    ...
    $ heroku apps:create mese-test
    Creating mese-test... done, stack is cedar
    http://mese-test.herokuapp.com/ | git@heroku.com:mese-test.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://mese-test.herokuapp.com deployed to Heroku

    To git@heroku.com:mese-test.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://mese-test.herokuap.com
    ["Hello" :from Heroku]
